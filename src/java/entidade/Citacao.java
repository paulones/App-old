...
@NamedQueries({
    ...
    @NamedQuery(name = "Citacao.findById", query = "SELECT c FROM Citacao c WHERE c.id = :id"),
    @NamedQuery(name = "Citacao.findByTipoCitacao", query = "SELECT c FROM Citacao c WHERE c.tipoCitacao = :tipoCitacao"),
    @NamedQuery(name = "Citacao.findByCitado", query = "SELECT c FROM Citacao c WHERE c.citado = :citado"),
    @NamedQuery(name = "Citacao.findByMotivo", query = "SELECT c FROM Citacao c WHERE c.motivo = :motivo"),
    @NamedQuery(name = "Citacao.findByDataDaCitacao", query = "SELECT c FROM Citacao c WHERE c.dataDaCitacao = :dataDaCitacao"),
    @NamedQuery(name = "Citacao.findByEndereco", query = "SELECT c FROM Citacao c WHERE c.endereco = :endereco"),
...
public class Citacao implements Serializable {
    ...
    public Citacao(Integer id) {
        this.id = id;
    }

    public Citacao(Integer id, String tipoCitacao, Character citado) {
        this.id = id;
